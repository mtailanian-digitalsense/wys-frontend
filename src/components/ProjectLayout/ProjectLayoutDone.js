...
export default class ProjectLayoutDone extends Component {
    constructor(props) {
      super(props);
    ...
    render() {
        ...
        return (
            <div className="results-screen m2 layout">
                <div className="results">
                    <div className="content">
                        <div className="alert-message">
                            <h1 className="area">LAYOUT</h1>
                            <h2 className="message">Finalizado con éxito</h2>
                        </div>
                        <div className="result-area">
                            <div className="button-area item">
                                <Link
                                    to={"/proyecto/" + this.props.project_id + "/layout"}
                            ...
                            <div className="result-data item">
                                <div className="result-box">
                                    <h3 className="title">Layout Seleccionado</h3>
                                    <h4 className="data cost-result-name uppercase">
                                        {project.layout==="completed"?"Completado":""}
                                    </h4>
                                </div>
                            </div>
                            <div className="button-area item">
                ...
                <ModuleDoneModules project={project} ignore="layout" />
            </div>
        );
    }
}