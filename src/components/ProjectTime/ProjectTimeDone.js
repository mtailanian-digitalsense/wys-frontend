...
export default class ProjectSearchDone extends Component {
    ...
    render() {
        ...
        return (
            <div className="results-screen m2 time">
                <div className="results">
                    <div className="content">
                        <div className="alert-message">
                            <h1 className="area">Estimador de plazos</h1>
                            <h2 className="message">Finalizado con éxito</h2>
                        </div>
                        <div className="result-area">
                            <div className="button-area item">
                                <Link
                                    to={"/proyecto/" + this.props.project_id + "/estimador_de_plazos"}
                            ...
                            <div className="result-data item">
                                <div className="result-box">
                                    <h3 className="title">Plazo estimado</h3>
                                    <h4 className="data time-result-name uppercase">
                                        {project.time} semanas
                                    </h4>
                                </div>
                            </div>
                            <div className="button-area item">
                ...
                <ModuleDoneModules project={project} ignore="time" />
            </div>
        );
    }
}
